...
const features = [
  ...
  {
    name: "AI Playground",
    description: "Experiment with AI models, tune parameters, compare outputs side by side",
    href: "/ai-playground",
    icon: FlaskConical,
  ...
  {
    name: "Prompt Studio",
    description: "Engineer, test, and A/B test prompts with template variables",
    href: "/prompt-studio",
    icon: Wand2,
  ...
  },
  {
    ...
    description: "Upload documents for AI analysis, summarization, and Q&A",
  ...
  },
  {
    ...
    description: "Generate images with DALL-E in 10 artistic styles",
  ...
  {
    name: "Code Generator",
    description: "AI code generation, review, test writing in 12 languages",
    href: "/code-generator",
    icon: Code2,
    color: "text-lime-500",
    bg: "bg-lime-500/10",
  },
  {
    ...
    description: "Process hundreds of items through AI with parallel execution",
